...
ifl.open("/home/student2018/scp002/webdata/Tri.txt");
    if (!ifl)
    {
...
// Getting Connections for each node and building TRIANGULARArray
...
while(!Q.empty()) // While there is stuff in the queue
    {
        ...
        {
            if (Nodes[current][i] == true || Nodes[i][current] == true) // if the connection exists
            {
